...
### Using a Custom Kubernetes Scheduler with vCluster

In addition to using the standard Kubernetes scheduler, it is also possible to use a custom scheduler. The example below shows how to configure a vCluster to use the Volcano custom scheduler:
